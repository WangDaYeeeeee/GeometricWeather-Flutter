...
import wangdaye.com.geometricweather_flutter.background.polling.services.permanent.update.ForegroundNormalUpdateService;
import wangdaye.com.geometricweather_flutter.background.polling.services.permanent.update.ForegroundTodayForecastUpdateService;
import wangdaye.com.geometricweather_flutter.background.polling.services.permanent.update.ForegroundTomorrowForecastUpdateService;
...
public class TimeObserverService extends Service {
    ...
    private void initData() {
        sPollingRate = 1.5f;
        sTodayForecastTime = BackgroundPlugin.VALUE_DEFAULT_TODAY_FORECAST_TIME;
        sTomorrowForecastTime = BackgroundPlugin.VALUE_DEFAULT_TOMORROW_FORECAST_TIME;
        sLastUpdateNormalViewTime = System.currentTimeMillis();
        sLastTodayForecastTime = System.currentTimeMillis();
        sLastTomorrowForecastTime = System.currentTimeMillis();
    }
